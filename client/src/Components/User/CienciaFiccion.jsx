      ...
      <>
        ...
        <div className="clasicos-container">
          <div className="loading">
            ...
            <p>Cargando libros de ciencia ficción...</p>
          </div>
        </div>
        <Footer />
      </>
      ...
      <>
        ...
        <div className="clasicos-container">
          <div className="error">
            ...
            <p>{error}</p>
            <button onClick={fetchSciFiBooks} className="retry-button">
      ...
      <div className="clasicos-container">
        ...
        {books.length === 0 ? (
          <div className="no-books">
            ...
            <p>No hay libros de ciencia ficción disponibles en este momento.</p>
          </div>
        ) : (
